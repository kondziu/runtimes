...
#[derive(PartialEq,Debug,Copy,Clone)] pub struct Size(usize);
#[derive(PartialEq,Debug,Copy,Clone)] pub struct Address(u64);
#[derive(PartialEq,Debug,Copy,Clone)] pub struct ConstantPoolIndex(u64);
#[derive(PartialEq,Debug,Copy,Clone)] pub struct LocalFrameIndex(u64);

impl Size              { pub fn new(value: usize) -> Size              { Size(value)              }}
impl Address           { pub fn new(value: u64)   -> Address           { Address(value)           }}
impl ConstantPoolIndex { pub fn new(value: u64)   -> ConstantPoolIndex { ConstantPoolIndex(value) }}
impl LocalFrameIndex   { pub fn new(value: u64)   -> LocalFrameIndex   { LocalFrameIndex(value)   }}
...
impl Serializable for ConstantPoolIndex {
    ...
    fn from_bytes<R: Read>(input: &mut R) -> Self {
        ConstantPoolIndex(serializable::read_u64(input))
    }
}
...
impl Serializable for LocalFrameIndex {
    ...
    fn from_bytes<R: Read>(input: &mut R) -> Self {
        LocalFrameIndex(serializable::read_u64(input))
    }
}